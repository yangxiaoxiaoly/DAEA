...
#data_path = DATA_PATH,des_dict_path = DES_DICT_PATH

def read_data(data_path,des_dict_path):
    ...
    index2ent1 = read_id2object([data_path + "ent_ids_1"])
    index2ent2 = read_id2object([data_path + "ent_ids_2"])
    ...
    return ent_ill, train_ill, test_ill, index2rel, index2entity, rel2index, entity2index, ent2data, rel_triples_1, rel_triples_2, index2ent1,index2ent2
